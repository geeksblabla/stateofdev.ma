...
Focusing on Front-end frameworks & libraries, we see that React.js is the king of the hill. We also noticed that over 25% of respondents still use jQuery on a daily basis.
...
Focusing on backend frameworks & libraries, we see that React.js is the king of the hill. We also noticed that over 25% of respondents still use jQuery on a daily basis.
