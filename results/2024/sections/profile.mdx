...
More than half of the respondents qualify themselves as developers in general: whether it is web (front-end and/or back-end), mobile, game or embeded development.
After developers, the second place is held by data-related roles.
Other technical positions, management and academical roles are much less represented.
