...
Since it's founding, [developer circles Morocco community](https://www.facebook.com/groups/DevC.Casablanca) aims to be the place for Moroccan developers to learn new things, share knowledge and move the IT community forward. We were always thinking how to best serve the community, and along the way we needed to understand it.
